...
import com.cta.misc.main.AbstractMain;
...
public class EmbededServer extends AbstractMain {
	...
	public static void main(String[] args) {
	    EmbededServer embleddedServer = new EmbededServer();
	...
	protected void execute(String[] args, boolean joinServerThread) {
        ...
        if(cmd.hasOption('h')) {
            ...
            try {
                ...
                final XmlWebApplicationContext webApplicationContext = WebConfigurerHelper.configureSpringContext(servletContext, "classpath:spring/standalone-context.xml");
